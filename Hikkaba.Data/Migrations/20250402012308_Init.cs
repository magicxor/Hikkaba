        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpAddressType = table.Column<int>(type: "int", nullable: false),
                    BannedIpAddress = table.Column<byte[]>(type: "varbinary(16)", maxLength: 16, nullable: false),
                    BannedCidrLowerIpAddress = table.Column<byte[]>(type: "varbinary(16)", maxLength: 16, nullable: true),
                    BannedCidrUpperIpAddress = table.Column<byte[]>(type: "varbinary(16)", maxLength: 16, nullable: true),
                    CountryIsoCode = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: true),
                    AutonomousSystemNumber = table.Column<long>(type: "bigint", nullable: true),
                    AutonomousSystemOrganization = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostToReply", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostToReply_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bans_BannedCidrLowerIpAddress",
                table: "Bans",
                column: "BannedCidrLowerIpAddress");

            migrationBuilder.CreateIndex(
                name: "IX_Bans_BannedCidrUpperIpAddress",
                table: "Bans",
                column: "BannedCidrUpperIpAddress");

            migrationBuilder.CreateIndex(
                name: "IX_Bans_BannedIpAddress",
                table: "Bans",
                column: "BannedIpAddress");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesToModerators_CategoryId",
                table: "CategoriesToModerators",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoriesToModerators_ModeratorId",
                table: "CategoriesToModerators",
                column: "ModeratorId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_BlobContainerId",
                table: "Posts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostToReply_PostId",
                table: "PostToReply",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_PostToReply_ReplyId",
                table: "PostToReply",
                column: "ReplyId");
