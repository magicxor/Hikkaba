...
public static partial class ApplicationUserMapper
{
    ...
    public static partial ApplicationUserPreviewRm ToPreviewRm(this ApplicationUser entity);

    public static partial IReadOnlyList<ApplicationUserPreviewRm> ToPreviewRms(this IReadOnlyList<ApplicationUser> entities);
}
