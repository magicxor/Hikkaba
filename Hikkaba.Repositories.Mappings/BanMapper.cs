...
{
    [MapProperty(nameof(Ban.Id), nameof(BanPreviewRm.Id))]
    [MapProperty(nameof(Ban.EndsAt), nameof(BanPreviewRm.EndsAt))]
    [MapProperty(nameof(Ban.Reason), nameof(BanPreviewRm.Reason))]
    ...
    public static partial BanPreviewRm ToPreviewRm(this Ban entity);
}
