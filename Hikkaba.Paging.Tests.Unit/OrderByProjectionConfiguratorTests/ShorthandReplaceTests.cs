...
[TestFixture]
public sealed class ShorthandReplaceTests
{
    private const string DbName = "ShorthandReplaceTests";
    ...
    public void SetUp()
    {
        OrderByProjectionConfig
            .ForType<Person>()
            .Replace(nameof(PersonDto.FullName), nameof(Person.Name), nameof(Person.Surname));
    }
