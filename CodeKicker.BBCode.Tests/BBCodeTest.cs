...
namespace Narochno.BBCode.Tests
{
    public partial class BBCodeTest
    {
        ...
        static void ReplaceTextSpans_ManualTestCases_TestCase(string bbCode, string expected, Func<string, IList<TextSpanReplaceInfo>> getTextSpansToReplace, Func<TagNode, bool> tagFilter)
        {
            ...
            var tree2 = CodeKicker.BBCode.BBCode.ReplaceTextSpans(tree1, getTextSpansToReplace ?? (txt => new TextSpanReplaceInfo[0]), tagFilter);
        ...
        public void ReplaceTextSpans_WhenNoModifications_TreeIsPreserved()
        {
            ...
            var tree2 = CodeKicker.BBCode.BBCode.ReplaceTextSpans(tree1, txt => new TextSpanReplaceInfo[0], null);
        ...
        {
            var tree1 = BBCodeTestUtil.GetAnyTree();
            var tree2 = CodeKicker.BBCode.BBCode.ReplaceTextSpans(tree1, txt => new[] { new TextSpanReplaceInfo(0, 0, null), }, null);
