...
public interface IPostRepository
{
    ...
    Task<PostCreateResultModel> CreatePostAsync(PostCreateExtendedRequestModel requestModel, FileAttachmentContainerCollection inputFiles, CancellationToken cancellationToken);
}
