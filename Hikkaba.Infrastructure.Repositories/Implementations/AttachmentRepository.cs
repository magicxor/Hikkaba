        ...
        return new AttachmentCollections
        {
            Audios = inputFiles.OfType<AudioFileAttachmentStreamContainer>()
                ...
                .Select(f => new Audio
                {
                    ...
                    FileNameWithoutExtension = f.FileNameWithoutExtension.TakeLeft(Defaults.MaxFileNameLength),
                    FileExtension = f.FileExtension.TakeLeft(Defaults.MaxFileExtensionLength),
                    FileSize = f.FileSize,
                    FileContentType = f.FileContentType.TakeLeft(Defaults.MaxFileContentTypeLength),
                    FileHash = f.FileHash,
                    Title = f.Title,
                    Album = f.Album,
                    Artist = f.Artist,
