...
using Hikkaba.Repositories.Mappings;
...
public class AdministrationRepository : IAdministrationRepository
{
    ...
    public async Task<DashboardRm> GetDashboardAsync()
    {
        ...
        var dashboardItemsDto = dashboardItems
            .Select(categoryModerators => new CategoryModeratorsRm
            {
                Category = categoryModerators.Category.ToDashboardViewRm(),
                Moderators = categoryModerators.Moderators.ToPreviewRms(),
            })
            .ToList();

        return new DashboardRm
        {
