...
/// Analyzed user agent
/// </summary>
public readonly struct HttpUserAgentInformation : IEquatable<HttpUserAgentInformation>
{
    /// <summary>
    ...
    {
        if (obj is not HttpUserAgentInformation other)
            return false;

        return string.Equals(UserAgent, other.UserAgent, StringComparison.OrdinalIgnoreCase)
               && Type == other.Type
               && string.Equals(Name, other.Name, StringComparison.OrdinalIgnoreCase)
               && string.Equals(Version, other.Version, StringComparison.OrdinalIgnoreCase)
               && string.Equals(MobileDeviceType, other.MobileDeviceType, StringComparison.OrdinalIgnoreCase);
    }

    public bool Equals(HttpUserAgentInformation other)
    {
        return string.Equals(UserAgent, other.UserAgent, StringComparison.OrdinalIgnoreCase)
               && Type == other.Type
               && string.Equals(Name, other.Name, StringComparison.OrdinalIgnoreCase)
    ...
    {
        return HashCode.Combine(UserAgent, Type, Name, Version, MobileDeviceType);
    }

    public override string ToString()
    {
        return $"{nameof(HttpUserAgentInformation)}: {UserAgent} ({Type})";
    }

    public static bool operator ==(HttpUserAgentInformation left, HttpUserAgentInformation right)
    {
