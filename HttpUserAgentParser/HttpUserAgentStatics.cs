...
public static class HttpUserAgentStatics
{
    ...
    /// Browsers
    /// </summary>
    [SuppressMessage("Correctness", "SS004:Implement Equals() and GetHashcode() methods for a type used in a collection.", Justification = "3rd party impl.")]
    public static readonly IReadOnlyDictionary<Regex, string> Browsers = new Dictionary<Regex, string>()
    {
    ...
    /// Mobiles
    /// </summary>
    public static readonly IReadOnlyDictionary<string, string> Mobiles = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase)
    {
        // Legacy
